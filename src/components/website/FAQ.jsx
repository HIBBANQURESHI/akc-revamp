...
export default function FAQ() {
  ...
  return (
    <div className="flex flex-col px-14 mt-8">
      <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-left mb-6 text-sky-300">Frequently Asked Questions for Website Design and Development Company</h1>
